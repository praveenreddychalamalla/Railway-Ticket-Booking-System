...
server.c        : This is server side connection file which fetches data from client.c and perform subsequent operations on it and 
                  communicate the response to client.
